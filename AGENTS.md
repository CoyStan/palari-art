...
- `npm run build:pages` creates a verified 225.4 MiB artifact at the `/palari-art/` base path containing 314 avatar WebPs, 1,395 runtime-mask WebPs, 40 gallery WebPs, and 123 Palari V2 WebPs with no PNG, PDF, or audit files.
