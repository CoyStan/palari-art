...
- `npm run build:pages` creates a verified 220.9 MiB artifact at the `/palari-art/` base path containing 314 avatar WebPs, 1,395 runtime-mask WebPs, and 40 gallery WebPs with no PNG, PDF, or audit files.
