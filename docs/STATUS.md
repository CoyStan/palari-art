...
- **The public editor is deployed:** GitHub Pages serves the browser-only app at `https://coystan.github.io/palari-art/`. `npm run build:pages` creates its verified 216.7 MiB artifact containing 314 avatar WebPs and 1,395 mask WebPs with no PNG masters or audit layers.
