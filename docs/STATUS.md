...
- The responsive browser app provides a 6 × 4 desktop picker that reflows to five or four columns, a large companion preview, soft/circle/square frames, Cover/Balls inspection, non-repeating surprise selection, URL-linked IDs and generated seeds, and local 1024 × 1024 PNG download. Playwright verified the 1536 × 1024, 390 × 844, and 320 × 568 layouts, all 24 accessible choices, six matching generated picker covers, visible head/chest/arm/hat balls with exactly 11 joints and no cover geometry in Balls view, motion on/off, the 680ms tap response, stable seed reload, reduced-motion behavior, covered PNG export while Balls is visible, and zero horizontal overflow.
